...
public class PeerSendsAckToDN {
    ...
    public PeerSendsAckToDN() {
        this.type = Constants.MESSAGES.PEER_SENDS_ACK_REGISTRATION;
    }

    public PeerSendsAckToDN(byte[] marshalledBytes) {
        try {
    ...
    public String toString() {
        return "PeerSendsAckToDN{" + "type=" + type + ", id=" + id + ", ipPort=" + ipPort + ", nickname=" + nickname + '}';
    }
}
