 ...
 * @author namanrs
 */
public class PeerSendsReRegistrationRequest {
    ...
    public PeerSendsReRegistrationRequest() {
        this.type = Constants.MESSAGES.PEER_SENDS_RE_REGISTRATION_REQUEST;
    }

    public PeerSendsReRegistrationRequest(byte[] marshalledBytes) {
        try {
    ...
    public String toString() {
        return "PeerSendsRe-RegistrationRequest{" + "type=" + type + ", id=" + id + ", ipPort=" + ipPort + ", nickname=" + nickname + '}';
    }
}
